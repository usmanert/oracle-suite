...
func (x *MessagePack) GetMessages() [][]byte {
	if x != nil {
		return x.Messages
	}
	return nil
...
var file_pb_proto_rawDesc = []byte{
	...
	0x75, 0x72, 0x65, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x5f,
	0x0a, 0x0b, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x50, 0x61, 0x63, 0x6b, 0x12, 0x16, 0x0a,
	...
	0x75, 0x72, 0x65, 0x12, 0x1a, 0x0a, 0x08, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x73, 0x18,
	0x03, 0x20, 0x03, 0x28, 0x0c, 0x52, 0x08, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x73, 0x42,
	...
	0x2f, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x70, 0x6f, 0x72, 0x74, 0x2f, 0x6c, 0x69, 0x62, 0x70, 0x32,
	0x70, 0x2f, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x73, 0x2f, 0x70, 0x62, 0x62, 0x06, 0x70,
...
var file_pb_proto_goTypes = []interface{}{
	(*Price)(nil),           // 0: Price
	(*Event)(nil),           // 1: Event
	(*MessagePack)(nil),     // 2: MessagePack
	(*Event_Signature)(nil), // 3: Event.Signature
	nil,                     // 4: Event.DataEntry
	nil,                     // 5: Event.SignaturesEntry
}
var file_pb_proto_depIdxs = []int32{
	4, // 0: Event.data:type_name -> Event.DataEntry
	5, // 1: Event.signatures:type_name -> Event.SignaturesEntry
	3, // 2: Event.SignaturesEntry.value:type_name -> Event.Signature
